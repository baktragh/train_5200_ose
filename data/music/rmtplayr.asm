;===============================================================================
; Raster music tracker routine from RMT 1.28
; Customized for Atari 5200.
; - Pokey at $E800
; - Pokey settings do not prevent keypad from working
;===============================================================================
...
rmt_silence
	...
	sta $e808
	sta $e818
	ldy #2                  ;Changed from #3 to #2 for Atari 5200
	sty $e80f
	sty $e81f
	ldy #8
si1	sta $e800,y
